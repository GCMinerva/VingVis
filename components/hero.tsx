  ...
  const cards = [
    {
      ...
      description: "Preview walking robots, tighten turns, and lock in faster scoring routes.",
    ...
    {
      title: "Servo Sync",
      description: "Schedule intakes, slides, and claws while the drivetrain keeps moving.",
    ...
    <div id="hero-section" className="bg-background relative min-h-screen w-full overflow-x-hidden py-32 md:px-6">
      ...
      <div className="container mx-auto px-4 2xl:max-w-[1400px]">
        ...
        <div className="mx-auto mt-5 max-w-3xl text-center">
          ...
          >
            Plan match-winning FTC autonomous routines with VingVis.
          </motion.h1>
        </div>
        <motion.div
        ...
        >
          <p className="text-muted-foreground text-xl">
            Calibrate drivetrain arcs, choreograph mechanisms, and deploy to your robot without touching Android Studio.
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <Link prefetch={false} href="/waitlist">
          ...
          <Link prefetch={false} href="/#pricing">
            <Button variant={"secondary"}>
              See pricing <MoveRight className="ml-2 h-4 w-4" />
            </Button>
          </Link>
        </motion.div>
        <motion.div
        ...
        >
          ...
          />
          <span className="text-sm text-gray-500">Powered by battle-tested tools like</span>
          <img
            src="/nextjs.webp"
            draggable={false}
            alt="Next.js"
