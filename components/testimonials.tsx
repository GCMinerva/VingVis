...
const testimonials = [
  {
    name: "Arjun Mehta",
    username: "@ftc7623",
    body: "VingVis cut our autonomous debug time from nights to minutes. The walk cycle preview shows exactly what the robot will do on the field.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Sara Lin",
    username: "@coachlin",
    body: "My rookies built a reliable auto path in a single practice. Drag a node, set a heading, and VingVis handles the math.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Devon Carter",
    username: "@botbuilders",
    body: "The AI Kit nails intake timing. We synced our slides, arm, and drive so the robot scores while it moves.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Priya Shah",
    username: "@ftcphoenix",
    body: "Uploading straight from the browser is wild. We iterate, deploy, and rerun without ever touching Android Studio.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Leo Martin",
    username: "@ctrlaltbot",
    body: "Telemetry with no credit limits means we can chase every tenth. The cloud history keeps our best runs safe.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Chloe Winters",
    username: "@winterbots",
    body: "Expansion Hub support let us add our turret and dual intake without rewriting code. Just drop in the node.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Ayaan Malik",
    username: "@ayaan_ftc",
    body: "We storyboarded the whole match in the Advanced TeleOp composer. Drivers loved practicing with the same flow they'll use on field.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Monica Reeves",
    username: "@sparkscoach",
    body: "Obstacle packs make field camps easier. Students drag the ovoid kit nodes and instantly see the clearance animation.",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "James Roy",
    username: "@drivecoachjr",
    body: "We finally maxed auto points at league meet. VingVis keeps every movement precise, even when the field is dusty.",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            FTC coaches, captains, and rookies rely on VingVis to deliver consistent autonomous runs when it matters most.
          </p>
        </div>
